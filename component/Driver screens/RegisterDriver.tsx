  ...
  const handleNext = async () => {
   ...
   Alert.alert(t("Error.error"), t("Error.Email already exists"));
    ...
    try {
      ...
      //   axios.get(`${environment.API_BASE_URL}api/collection-manager/driver/check-nic/${formData.nicNumber}`),
      //   axios.get(`${environment.API_BASE_URL}api/collection-manager/driver/check-phone/${phoneCode1}${phoneNumber1}`)
      // ]);
