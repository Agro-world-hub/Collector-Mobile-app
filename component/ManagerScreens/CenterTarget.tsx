...
const CenterTarget: React.FC<CenterTargetProps> = ({ navigation }) => {
  ...
  const gradeOrder = ['A', 'B', 'C'];  // Define custom grade order

  // Function to sort by grade and variety name
  const sortData = (data: TargetData[]) => {
    return data.sort((a, b) => {
      ...
      // If grades are the same, sort by variety name (alphabetically)
