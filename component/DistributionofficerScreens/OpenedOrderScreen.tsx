...
type OpenedOrderScreenNavigationProps = StackNavigationProp<RootStackParamList, 'OpenedOrderScreen'>;
type OpenedOrderScreenRouteProp = RouteProp<
  RootStackParamList,
  "OpenedOrderScreen"
>;

interface OpenedOrderScreenProps {
  navigation: OpenedOrderScreenNavigationProps;
  route: OpenedOrderScreenRouteProp;
}

const OpenedOrderScreen: React.FC<OpenedOrderScreenProps> = ({ navigation, route }) => {
  ...
  <Text className="text-gray-800 text-lg font-medium">{t("OpenedOrderScreen.INV No")} {orderData.invoiceNo}</Text>
       ...
       <View className="mx-4 mt-4 mb-3 justify-center items-center">
                      <View className="bg-[#F8FFA6] border border-[#F8FFA6] px-3 py-2 rounded-lg">
                        <Text className="text-[#A8A100] font-medium text-sm">{t("OpenedOrderScreen.Opened")}</Text>
                      </View>
                    </View>
      ...
      <ScrollView className="flex-1">
        ...
        <View className="mx-4 mb-3">
          <TouchableOpacity 
            className="bg-[#FBFFD1] border border-[#A8A100] px-4 py-3 rounded-lg flex-row justify-between items-center"
          ...
          {familyPackExpanded && (
            <View className="bg-white border border-[#F5F563] rounded-b-lg px-4 py-4 -mt-1">
              ...
              {/* Add Weight Button */}
              <TouchableOpacity 
                className="bg-[#4CAF50] py-3 rounded-lg flex-row items-center justify-center mt-4"
...
export default OpenedOrderScreen;