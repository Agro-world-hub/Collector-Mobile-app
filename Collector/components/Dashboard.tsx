  ...
  return (
    <View className="flex-1">
      ...
      <View className="bg-green-500 p-4 rounded-b-3xl w-full h-[100px] flex-row justify-between items-center">
        <Text className="text-white text-xl ml-5 font-bold">Hi, Nimesh!</Text>
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 20, paddingHorizontal: 30 }}>
        ...
        <View className="mt-20 space-y-4">
          ...
          >
            <Text className="text-white text-center mt-2 text-xl font-semibold" onPress={() => navigation.navigate('Registeredfarmer')} >
              Registered{'\n'}Farmer
            </Text>
          </TouchableOpacity>
          ...
          >
            <Text className="text-white text-center mt-2 text-xl font-semibold" onPress={()=>navigation.navigate('UnregisteredFarmerDetails')}>
              Unregistered{'\n'}Farmer
            </Text>
          </TouchableOpacity>
        </View>
