...
type SinUfarmercropdetailsNavigationProp = StackNavigationProp<RootStackParamList, 'SinUfarmercropdetails'>;

interface SinUfarmercropdetailsProps {
  navigation: SinUfarmercropdetailsNavigationProp;
}

const SinUfarmercropdetails: React.FC<SinUfarmercropdetailsProps> = ({ navigation }) => {
  ...
  return (
    <View className='flex-1 bg-white'>
      <View className='flex-row pt-[7%] pl-[3%] pb-[5%]'>
        ...
        <Text className='text-xl pl-[22%] text-center'>බෝගවල විස්තර පුරවන්න</Text>
      </View>

      <View className='ml-[10%] mr-[10%] flex-1'>
        <ScrollView contentContainerStyle={{ paddingBottom: 20 }}>
          <Text className='text-base pb-[2%] font-medium'>බෝගයේ නම</Text>
          ...
          <Text className='text-base pb-[2%] font-medium'>ගුණාත්මකභාවය</Text>
          ...
          <Text className='text-base pb-[2%] font-medium'>ප්‍රමාණය</Text>
          ...
          <Text className='text-base pb-[2%] font-medium'>ඒකක මිල (Rs.)</Text>
          <View style={{ borderColor: 'gray', borderWidth: 1, borderRadius: borderRadiusValue, marginBottom: 16, backgroundColor: 'white' }}>
            <TextInput
              className="flex-1 h-[40px] text-base pl-2"
          ...
          <Text className='text-base pb-[2%] font-medium'>චායාරූපය ඇතුලත් කරන්න</Text>
          <TouchableOpacity
            className="flex-row items-center border w-full h-[40px] mb-5 bg-black px-3 justify-center"
            style={{ borderRadius: borderRadiusValue }}
            onPress={handleChooseImage}
          >
            <Text className='text-base pl-2 text-white'>චායාරූපය ඇතුලත් කරන්න</Text>
          </TouchableOpacity>
          ...
          <Text className='text-base pb-[2%] font-medium'>මුලු වටිනාකම (Rs.)</Text>
          <View style={{ borderColor: 'gray', borderWidth: 1, borderRadius: borderRadiusValue, marginBottom: 16, backgroundColor: 'white' }}>
            <TextInput
              className="flex-1 h-[40px] text-base pl-2"
              value={total}
          ...
          <TouchableOpacity className='bg-[#2AAD7A] w-full h-[50px] rounded-3xl shadow-2xl items-center justify-center' onPress={()=>navigation.navigate('SinUnregisteredCropDetails')}>
            <Text className='text-center text-xl font-light text-white'>සුරකින්න</Text>
          </TouchableOpacity>
        </ScrollView>
...
export default SinUfarmercropdetails;
